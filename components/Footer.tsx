        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-24">
          ...
          {[
            { 
              title: "台中本社", 
              items: [
                { icon: <MapPinIcon />, text: "407台中市西屯區\n台湾大道四段925号16階の3" },
            ...
            { 
              title: "台北オフィス", 
              items: [
                { icon: <MapPinIcon />, text: "235 新北市中和區\n建一路186号11階 (第一オフィス)" },
                { icon: <MapPinIcon />, text: "114 台北市内湖區\n瑞光路335号3F (第二オフィス)" },
            ...
            { 
              title: "台南オフィス", 
              items: [
                { icon: <MapPinIcon />, text: "700 台南市中西區\n樹林街二段33号思源楼2階 M211" },
        ...
        <div className="border-t border-gray-200 dark:border-white/10 pt-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
          <div className="flex flex-col gap-2">
            <p className="text-xs text-gray-500">
              Copyright &copy; 2011-{currentYear} 
            </p>
            <a href="http://ct-cloud.com/" target="_blank" rel="noreferrer" className="text-xs text-gray-500 hover:text-black dark:hover:text-white transition-colors">
              誠雲科技股份有限公司 (CT-Cloud Technology Co., LTD.)
            </a>
          </div>
